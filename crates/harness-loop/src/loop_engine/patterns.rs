...
//! model, tools, sandbox, and gate via [`crate::loop_engine::LoopEngine`], or hand to the
//! [`crate::loop_engine::LoopScheduler`] to run on its cadence.
//!
...
use crate::loop_engine::budget::TokenBudget;
use crate::loop_engine::level::LoopLevel;
...
mod tests {
    ...
    fn every_pattern_cadence_parses() {
        for spec in catalogue() {
            assert!(
                crate::daemon::Schedule::parse(&spec.cadence).is_ok(),
