...
//! when you build a [`crate::loop_engine::LoopEngine`] from the spec. Keeping the spec
//! inert means it can be cloned, serialized, diffed, and unit-tested on its
//! own, and that the production [`crate::loop_engine::patterns`] are just constructors
...
pub struct LoopSpec {
    ...
    /// Cadence string parsed by `crate::daemon::Schedule`
