...
//! [`crate::experience::SkillDistiller`] / [`crate::experience::SkillReviser`]): the distiller only
...
pub struct Episode {
    ...
    /// by [`crate::experience::SkillUseTrace`]); the framework emits no skill-activation
