...
use crate::scheduler::channel::{Channel, ChannelRegistry};
...
mod tests {
    use super::*;
    use crate::scheduler::channel::{Channel, ChannelError};
    use crate::scheduler::store::{FileJobStore, Job, JobStore};
