...
use crate::orchestrator::dag::PlanDelta;
use crate::orchestrator::job::{Job, JobId, JobResult, JobState};
use crate::orchestrator::planner::Planner;
use crate::orchestrator::route::{Next, Router};
use crate::orchestrator::run::{Run, RunReport, RunState};
use crate::orchestrator::runner::JobRunner;
    ...
    fn report(&self, run: &Run) -> RunReport {
        RunReport {
            ...
            jobs: run
                .dag
                .jobs()
                .map(|j| crate::orchestrator::run::JobReport {
                    id: j.id.clone(),
                    state: j.state,
