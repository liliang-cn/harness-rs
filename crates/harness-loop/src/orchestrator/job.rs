...
pub struct Job {
    ...
    /// every time a [`Next::Goto`](crate::orchestrator::Next) sent the graph back through it.
    ...
    /// Set only by a [`Next::Goto`](crate::orchestrator::Next); the runner puts both in front
