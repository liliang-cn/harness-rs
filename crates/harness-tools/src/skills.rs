...
impl Tool for SkillManageTool {
    ...
    async fn invoke(&self, args: Value, _w: &mut World) -> Result<ToolResult, ToolError> {
        ...
        if let Err(e) = harness_context::skills::validate_name(name) {
        ...
        let result: Result<Value, String> = match action {
            "create" | "edit" => {
                ...
                harness_context::skills::write_skill_md(&self.dir, name, content)
                ...
                match std::fs::read_to_string(&path) {
                    Ok(cur) => {
                        ...
                        if matches == 0 {
                            ...
                            harness_context::skills::write_skill_md(&self.dir, name, &patched)
            ...
            "delete" => harness_context::skills::delete_skill(&self.dir, name)
