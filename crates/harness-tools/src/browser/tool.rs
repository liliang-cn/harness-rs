...
use crate::browser::page::{self, ElementInfo, PageError};
use crate::browser::policy::{PublicOnlyPolicy, UrlPolicy};
use crate::browser::session::{
    BrowserSession, LaunchConfig, LaunchError, NO_BROWSER_HELP, find_browser,
};
...
impl BrowserTool {
    ...
    /// with this crate — see [`crate::browser::policy`] for what it is protecting.
...
async fn run_action(
    ...
    match action {
        ...
        "screenshot" => {
            ...
            let name = format!("browser-{}.png", crate::browser::session::unique_token());
