...
//! remember that [`crate::recall::SearchPastSessions`] exists.
//!
...
use crate::recall::{ago, clip, recall_owner, search_with_cjk_fallback};
...
mod tests {
    ...
    fn world() -> World {
        ...
        w.profile
            .extra
            .insert(crate::recall::RECALL_OWNER_KEY.into(), json!("alice"));
        w
    }
